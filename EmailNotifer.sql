...
BEGIN
	...
	DECLARE @profile_name VARCHAR(MAX) = 'DBMailer';
	DECLARE @email_to_address VARCHAR(MAX) = 'ruit-1csupport@airliquide.com';
...
EXEC msdb.dbo.sp_add_job @job_name=N'Job Failure Collection and Notification',
		...
		@notify_email_operator_name=N'ruit-1csupport@airliquide.com', @job_id = @jobId OUTPUT;
